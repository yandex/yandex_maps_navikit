...
void _NavigationUserPlacemarkStyleProvider_provideStyle(
  ...
  final listener =
      NavigationUserPlacemarkStyleProvider._pointerToListener[_ptr];
  if (listener == null) {
  ...
  try {
    listener.provideStyle(
      scaleFactor,
      isNightMode,
      mapkit_styling_placemark_style.PlacemarkStyle.fromNativePtr(style),
    );
  } catch (e, stack) {
...
void _NavigationRequestPointStyleProvider_provideStyle(
  ...
  final listener = NavigationRequestPointStyleProvider._pointerToListener[_ptr];
  if (listener == null) {
    throw core.Exception();
  }
  try {
    listener.provideStyle(
      requestPointIndex,
      requestPointsNumber,
      mapkit_request_point.RequestPointType.fromInt(requestPointType),
      scaleFactor,
      isSelected,
      isNightMode,
      mapkit_styling_placemark_style.PlacemarkStyle.fromNativePtr(style),
...
void _NavigationRoutePinsStyleProvider_provideTrafficLightStyle(
  ...
  final listener = NavigationRoutePinsStyleProvider._pointerToListener[_ptr];
  if (listener == null) {
    throw core.Exception();
  }
  try {
...
void _NavigationRoutePinsStyleProvider_provideRoadInPoorConditionStyle(
  ...
  try {
    listener.provideRoadInPoorConditionStyle(
      scaleFactor,
      isNightMode,
      mapkit_styling_placemark_style.PlacemarkStyle.fromNativePtr(
...
ffi.Pointer<ffi.Void> _NavigationStyleProvider_routeViewStyleProvider(
    ffi.Pointer<ffi.Void> _ptr) {
  final listener = NavigationStyleProvider._pointerToListener[_ptr];
  if (listener == null) {
    throw core.Exception();
  }
  try {
...
ffi.Pointer<ffi.Void> _NavigationStyleProvider_requestPointStyleProvider(
  ...
  try {
    return NavigationRequestPointStyleProvider.getNativePtr(
...
ffi.Pointer<ffi.Void> _NavigationStyleProvider_userPlacemarkStyleProvider(
  ...
  try {
    return NavigationUserPlacemarkStyleProvider.getNativePtr(
...
ffi.Pointer<ffi.Void> _NavigationStyleProvider_routePinsStyleProvider(
  ...
  try {
    return NavigationRoutePinsStyleProvider.getNativePtr(
