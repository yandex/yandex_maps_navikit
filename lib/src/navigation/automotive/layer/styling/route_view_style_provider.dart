...
@bindings_annotations.ContainerData(
    toNative: 'NavigationJamStyle.getNativePtr',
    toPlatform:
        '(val) => NavigationJamStyle.fromOptionalPtr(val.cast<ffi.Pointer<ffi.Void>>().value)')
class NavigationJamStyle implements ffi.Finalizable {
  @protected
  ...
  /// @nodoc
  NavigationJamStyle.fromExternalPtr(this.ptr);

  /// @nodoc
  @internal
  NavigationJamStyle.fromNativePtrImpl(this.ptr) {
    _finalizer.attach(this, ptr);
  }

  /// @nodoc
  @internal
  factory NavigationJamStyle.fromNativePtr(ffi.Pointer<ffi.Void> ptr) =>
  ...
  static NavigationJamStyle? fromOptionalPtr(ffi.Pointer<ffi.Void> ptr) {
    ...
    return NavigationJamStyle.fromNativePtr(ptr);
  }
...
@bindings_annotations.ContainerData(
    toNative: 'NavigationRouteStyle.getNativePtr',
    toPlatform:
        '(val) => NavigationRouteStyle.fromOptionalPtr(val.cast<ffi.Pointer<ffi.Void>>().value)')
class NavigationRouteStyle implements ffi.Finalizable {
  @protected
  final ffi.Pointer<ffi.Void> ptr;
  static final _finalizer =
  ...
  /// @nodoc
  NavigationRouteStyle.fromExternalPtr(this.ptr);

  /// @nodoc
  @internal
  NavigationRouteStyle.fromNativePtrImpl(this.ptr) {
    _finalizer.attach(this, ptr);
  }

  /// @nodoc
  @internal
  factory NavigationRouteStyle.fromNativePtr(ffi.Pointer<ffi.Void> ptr) =>
      weak_interface_wrapper.createFromNative(ptr);
  ...
  static NavigationRouteStyle? fromOptionalPtr(ffi.Pointer<ffi.Void> ptr) {
    if (ptr == ffi.nullptr) return null;
    return NavigationRouteStyle.fromNativePtr(ptr);
  }
...
void _NavigationRouteViewStyleProvider_provideJamStyle(
  ...
  final listener = NavigationRouteViewStyleProvider._pointerToListener[_ptr];
  if (listener == null) {
    throw core.Exception();
  }
  try {
    listener.provideJamStyle(
      directions_driving_flags.DrivingFlags.fromNative(flags),
      isSelected,
      isNightMode,
      NavigationJamStyle.fromNativePtr(jamStyle),
    );
  } catch (e, stack) {
...
void _NavigationRouteViewStyleProvider_providePolylineStyle(
  ...
  try {
    listener.providePolylineStyle(
      ...
      isSelected,
      isNightMode,
      mapkit_styling_polyline_style.PolylineStyle.fromNativePtr(polylineStyle),
    );
  } catch (e, stack) {
    exception.nativeAssert(
        'Unhandled exception $e from native call listener\n$stack');
...
void _NavigationRouteViewStyleProvider_provideManoeuvreStyle(
  ...
  try {
    listener.provideManoeuvreStyle(
      ...
      isSelected,
      isNightMode,
      mapkit_styling_arrow_style.ArrowStyle.fromNativePtr(arrowStyle),
    );
  } catch (e, stack) {
    exception.nativeAssert(
        'Unhandled exception $e from native call listener\n$stack');
...
void _NavigationRouteViewStyleProvider_provideRouteStyle(
  ...
  try {
    listener.provideRouteStyle(
      ...
      isSelected,
      isNightMode,
      NavigationRouteStyle.fromNativePtr(routeStyle),
    );
  } catch (e, stack) {
    exception.nativeAssert(
        'Unhandled exception $e from native call listener\n$stack');
