...
/// @nodoc
class _BalloonViewListenerWrapper implements ffi.Finalizable {
...
void _BalloonViewListener_onBalloonViewsChanged(
  ...
  final listener = BalloonViewListener._pointerToListener[_ptr]?.target;
  if (listener == null) {
    throw core.Exception();
  }
  try {
    listener.onBalloonViewsChanged(
        navigation_automotive_layer_route_view.RouteView.fromNativePtr(route));
  } catch (e, stack) {
...
void _BalloonViewListener_onBalloonViewTap(
  ...
  try {
    listener.onBalloonViewTap(
        navigation_automotive_layer_balloon_view.BalloonView.fromNativePtr(
            balloon));
  } catch (e, stack) {
    exception.nativeAssert(
        'Unhandled exception $e from native call listener\n$stack');
